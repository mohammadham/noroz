...
<section id="hero_in" class="courses start_bg_zoom" style="max-height: 318px;">
    <?php $blog_banner = 'uploads/blog/banner/'.$blog_details['banner']; ?>
    <?php if(file_exists($blog_banner) && is_file($blog_banner)): ?>
        <?php $blog_banner = base_url($blog_banner); ?>
    <?php else: ?>
        <?php $blog_banner = base_url('uploads/blog/banner/placeholder.png'); ?>
    <?php endif; ?>
    <div style="background: url(<?php echo $blog_banner; ?>) center center no-repeat;" class="banner-img"></div>
    <div class="wrapper">
        <div class="container">
            <h1 class="fadeInUp animated"><span></span><?php echo $blog_details['title']; ?></h1>
            <p class="w-100">
                <small style="color: #d3d3d3;"><?php echo site_phrase('published'); ?> - <?php echo get_past_time($blog_details['added_date']); ?></small>
            </p>
        </div>
    </div>
</section>
                ...
                <div class="row">
                	...
                	<div class="col-md-12">
						...
						<div class="row justify-content-center">
							...
							<div class="col-md-9 top-instructor-details text-md-start">
								<h4 class="mb-1 fw-600 v"><a class="text-decoration-none text-dark" href="<?php echo site_url('home/instructor_page/'.$user_details['id']); ?>"><?php echo $user_details['first_name'].' '.$user_details['last_name']; ?></a></h4>
								...
								<p class="mt-3">
									<a class="text-dark" href="<?php echo site_url('home/instructor_page/'.$blog_details['user_id']); ?>"><?php echo site_phrase('view_profile'); ?></a>
								</p>
							</div>
						</div>
                	</div>
                    ...
                    <div class="col-md-12 pt-4">
                        ...
                        <div class="row mt-4 mb-3">
                            ...
                            <div class="col-md-6 text-end">
                                <button class="btn btn-primary float-right" onclick="$('#add_your_comment').toggle();"><i class="fas fa-plus"></i> <?php echo site_phrase('add_your_comment'); ?></button>
                            </div>
                        </div>
                        ...
                        <div class="w-100 d-hidden mt-3" id="add_your_comment">
                            <form action="<?php echo site_url('blog/add_blog_comment/'.$blog_details['blog_id']); ?>" method="post">
                                ...
                                <div class="form-group my-3">
                                    <button type="submit" class="btn btn-primary py-2 radius-10"><?php echo site_phrase('publish'); ?></button>
                                </div>
                            </form>
                        </div>
                                ...
                                <div class="w-auto px-2">
                                    ...
                                    <div class="w-100 text-13px text-muted mt-2 d-flex">
                                        ...
                                        <?php if($this->session->userdata('user_id') == $blog_comment['user_id'] || $this->session->userdata('admin_login') == true): ?>
                                            ...
                                            <a class="mx-2" onclick="confirm_modal('<?php echo site_url('blog/delete_comment/'.$blog_comment['blog_comment_id'].'/'.$blog_details['blog_id']); ?>'); $('#delete_link').removeAttr('data-dismiss');" href="javascript:;"><i class="far fa-trash-alt"></i></a>
                                        <?php endif; ?>
                                    </div>
                                    ...
                                    <div class="w-100 d-hidden mt-3" id="comment_edit<?php echo $blog_comment['blog_comment_id']; ?>">
                                        <form action="<?php echo site_url('blog/update_blog_comment/'.$blog_comment['blog_comment_id']); ?>" method="post">
                                            ...
                                            <div class="form-group my-3">
                                                <button type="submit" class="btn btn-primary py-2 radius-10"><?php echo site_phrase('save_changes'); ?></button>
                                            </div>
                                        </form>
                                    </div>
                                            ...
                                            <div class="w-auto px-2">
                                                ...
                                                <div class="w-100 text-13px text-muted mt-2 d-flex">
                                                    ...
                                                    <?php if($this->session->userdata('user_id') == $child_comment['user_id'] || $this->session->userdata('admin_login') == true): ?>
                                                        <a class="mx-2" onclick="confirm_modal('<?php echo site_url('blog/delete_comment/'.$child_comment['blog_comment_id'].'/'.$blog_details['blog_id']); ?>'); $('#delete_link').removeAttr('data-dismiss');" href="javascript:;"><i class="far fa-trash-alt"></i></a>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </div>
