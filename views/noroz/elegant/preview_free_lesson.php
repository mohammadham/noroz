                ...
                if($lesson_details['lesson_type'] == 'video' || $lesson_details['lesson_type'] == '' || $lesson_details['lesson_type'] == NULL):
                    ...
                    <?php if (strtolower($provider) == 'youtube'): ?>
                        ...
                        <iframe id="player" type="text/html" width="100%" height="auto"
                          ...
                          frameborder="0" style="min-height: 380px;"></iframe>
                    ...
                    <?php elseif (strtolower($provider) == 'amazon'):?>
                        <!------------- PLYR.IO ------------>
                        <video poster="<?php echo $lesson_thumbnail_url;?>" id="player" playsinline controls width="100%" height="auto" controlsList="nodownload" style="opacity: 1 !important; position: relative; z-index: 2200;">
                    ...
                    <?php else: ?>
                        <div class="mt-3 text-center">
                            ...
                            <?php elseif($lesson_details['attachment_type'] == 'doc'): ?>
                                ...
                                <?php } ?>
                                <iframe width="100%" height="500px" class="doc" src="https://docs.google.com/gview?url=<?php echo base_url().'uploads/lesson_files/'.$lesson_details['attachment']; ?>&embedded=true" style="min-height: 380px;"></iframe>
                            <?php else: ?>
                                <iframe class="embed-responsive-item" width="100%" height="500px" src="<?php echo base_url().'uploads/lesson_files/'.$lesson_details['attachment']; ?>" style="min-height: 380px;" allowfullscreen></iframe>
                            <?php endif; ?>
                        </div>
                    <?php endif; ?>
                <?php endif; ?>
