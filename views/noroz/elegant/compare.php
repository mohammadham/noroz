...
<section id="hero_in" class="general">
  <div class="banner-img" style="background: url(<?php echo base_url('assets/frontend/elegant/images/balance-scale.png'); ?>) center center no-repeat;"></div>
  <div class="wrapper">
    <div class="container">
      <h1 class="fadeInUp"><span></span><?php echo site_phrase('course_compare'); ?></h1>
    </div>
  </div>
</section>
                                ...
                                <?php if (isset($course_1_details['id'])) : ?>
                                    ...
                                    <?php else : ?>
                                        <?php if ($course_1_details['is_free_course'] == 1) : ?>
                                            ...
                                            <?php endif; ?>
                                        <?php else : ?>
                                            <a href="javascript:;" class="btn btn-success" id="course_<?php echo $course_1_details['id']; ?>" onclick="handleBuyNow('<?php echo $course_1_details['id']; ?>')"><?php echo site_phrase('buy_now'); ?></a>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                <?php endif; ?>
                            </td>
                                ...
                                <?php if (isset($course_2_details['id'])) : ?>
                                    ...
                                    <?php else : ?>
                                        <?php if ($course_2_details['is_free_course'] == 1) : ?>
                                            ...
                                            <?php endif; ?>
                                        <?php else : ?>
                                            <a href="javascript:;" class="btn btn-success" id="course_<?php echo $course_2_details['id']; ?>" onclick="handleBuyNow('<?php echo $course_2_details['id']; ?>')"><?php echo site_phrase('buy_now'); ?></a>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                <?php endif; ?>
                            </td>
                                ...
                                <?php if (isset($course_3_details['id'])) : ?>
                                    ...
                                    <?php else : ?>
                                        <?php if ($course_3_details['is_free_course'] == 1) : ?>
                                            ...
                                            <?php endif; ?>
                                        <?php else : ?>
                                            <a href="javascript:;" class="btn btn-success" id="course_<?php echo $course_3_details['id']; ?>" onclick="handleBuyNow('<?php echo $course_3_details['id']; ?>')"><?php echo site_phrase('buy_now'); ?></a>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                <?php endif; ?>
                            </td>
