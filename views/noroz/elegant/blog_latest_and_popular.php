        ...
        <div class="row">
            <div class="col-lg-9">
                <div class="row row-cols-1 row-cols-lg-3 row-cols-md-2 g-4">
                    ...
                    <div class="col-12">
                        <a class="float-right btn btn-secondary px-3 fw-600" href="<?php echo site_url('blogs'); ?>"><?php echo site_phrase('view_all'); ?></a>
                    </div>
                </div>
                
                <?php if($popular_blogs->num_rows() > 0): ?>
                    <div class="row row-cols-1 row-cols-lg-3 row-cols-md-2 g-4 mt-4">
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            <div class="col-12">
                                <a class="float-right btn btn-secondary px-3 fw-600 mb-4" href="<?php echo site_url('blogs'); ?>"><?php echo site_phrase('view_all'); ?></a>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
